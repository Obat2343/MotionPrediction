...
class AttentionConv(nn.Module):
    ...
    This function can be used like convolution layer.
    The attention is calculated within the kernel not the whole image.
    """
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, groups=1, bias=False, pos_emb=True):
    ...
    def forward(self, x):
        ...
        if self.pos_emb:
            ...
            k_out = torch.cat((k_out_h, k_out_w), dim=1)
